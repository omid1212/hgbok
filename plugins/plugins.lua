...
local function run(msg, matches)
  ...
  if matches[1] == '!plugins' and is_admin(msg) then --after changed to moderator mode, set only sudo
  ...
  -- Enable a plugin
  if matches[1] == 'enable' and is_admin(msg) then --after changed to moderator mode, set only sudo
  ...
  -- Disable a plugin
  if matches[1] == 'disable' and is_admin(msg) then --after changed to moderator mode, set only sudo
  ...
  if matches[1] == 'reload' and is_admin(msg) then --after changed to moderator mode, set only sudo
    return reload_plugins(true)
  end
end
